function loadShoesList() {
    ...
    $.ajax({
        type: "get",
        url: "/shoes?get_name=1&get_main_image&get_price=1&get_sold=1&get_type=1&get_rate=1&sort_created_date=-1&state=1",
...
$('#shoes_state').change(function() {
    ...
    if(selectedValue == 0) {
        ...
        $.ajax({
            type: "get",
            url: "/shoes?get_name=1&get_main_image&get_price=1&get_sold=1&get_type=1&get_rate=1&sort_created_date=-1&state=0",
            success: function (response) {
                if (response.success) {
                    $('#shoes-list-container').empty()
                    $('#number_of_shoes').text(' ' + response.data.length)
        ...
        $.ajax({
            type: "get",
            url: "/shoes?get_name=1&get_main_image&get_price=1&get_sold=1&get_type=1&get_rate=1&sort_created_date=-1&state=2",
            success: function (response) {
                if (response.success) {
                    $('#shoes-list-container').empty()
                    $('#number_of_shoes').text(' ' + response.data.length)

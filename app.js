...
const _orderRouter = require('./routes/view/_order')
const _reportRouter = require('./routes/view/_report')
...
const userOfferRouter = require('./routes/api/user_offer')
const shoesReview = require('./routes/api/shoes_review')
...
app.use('/', _orderRouter)
app.use('/', _reportRouter)
app.use('/', adminRouter)
...
app.use('/user-offer', userOfferRouter)
app.use('/shoes-review', shoesReview)
